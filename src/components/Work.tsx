  ...
  return (
    <section id="work" className="py-20 bg-background">
      <div className="container">
        ...
        {/* Project Card */}
        <div className="bg-cream rounded-3xl p-8 max-w-4xl mx-auto">
          ...
          <div className="bg-card rounded-2xl p-6 border border-border">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <Button size="sm" className="rounded-full text-xs h-7">Download App</Button>
              </div>
            </div>
              ...
              <div className="relative">
                <div className="bg-green-500 rounded-2xl h-48 flex items-center justify-center overflow-hidden">
                  ...
                  <div className="relative z-10 flex items-center gap-4">
                    <div className="w-20 h-32 bg-card rounded-xl shadow-lg flex items-center justify-center">
                      <span className="text-xs text-muted-foreground">📱</span>
                    </div>
                    <div className="space-y-2">
                      <div className="bg-card/90 px-3 py-1 rounded-full text-xs">Effortless Shopping</div>
                      <div className="bg-primary px-3 py-1 rounded-full text-xs text-primary-foreground">Effortless Shopping</div>
                    </div>
                  </div>
                </div>
              </div>
